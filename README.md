...
> **Workshop resources by Ananda Rimal — AI Researcher / ML Instructor**
...
The slide deck (`resources/word2vec by ananda rimal.pptx`) walks through:

- The intuition behind distributed word representations
- Step-by-step CBOW and Skip-gram architectures
- The full forward pass, loss computation, and weight update cycle
- Negative sampling in detail
- Visual examples of learned embedding spaces

**License:** Slides and all educational content are released under **CC BY 4.0**.
You are free to use, share, adapt, and build upon this material for any purpose — including commercially — **as long as you give appropriate credit.**
...
```
Word2Vec Workshop Resources by Ananda Rimal | AI Researcher / ML Instructor
Licensed under CC BY 4.0 — https://creativecommons.org/licenses/by/4.0/
```

> ⚠️ Anyone can use these slides, but **credit to Ananda Rimal is required**.
